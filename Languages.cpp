...
/* TextChDwarf */ { "Swiss dwarf", "Gleissperrsignal", "Suiza señal enana" },
/* TextChLDistant */ { "Swiss type L distant", "Schweizer Typ L Vorsignal", "Suiza tipo L avanzada" },
/* TextChLMain */ { "Swiss type L main", "Hauptsignal", "Suiza tipo L principal" },
...
/* TextDcc */ { "DCC", "DCC", "DCC" },
/* TextDeCombined */ { "German Ks", "Vorsignal", "Alemaña Ks" },
...
/* TextHttpConnectionClosed */ { "HTTP connection {0}: closed", "HTTP Verbindung {0}: geschlossen", "HTTP connectión {0}: cerrado" },
/* TextHttpConnectionErrorReadingData */ { "HTTP connection {0}: {1}", "HTTP Verbindung {0}: {1}", "HTTP connectión {0}: {1}" },
...
/* TextHttpConnectionOpened */ { "HTTP connection {0}: opened", "HTTP Verbindung {0}: geöffnet", "HTTP connectión {0}: abierto" },
...
/* TextNoValidTimetableEntryFound */ { "No valid timetable entry found for {0}", "Kein Fahrplaneintrag gefunden für {0}", "Ninguna entrada encontrado en el horario para {0}" },
...
/* TextSignalStateClear60 */ { "Clear 60 km/h", "Hp2", "Vía libre 60 km/h" },
...
/* TextSignalStateShortClear */ { "Short Clear", "Sh0", "Vía libre corta" },
